...
20b2.2 Convert PlannedWorkoutRepository to AsyncPlannedWorkoutRepository. [complete]
...
20c2.1 Convert set-related endpoints to async using AsyncSetRepository. [complete]
20c2.2 Convert planned workout endpoints to async.
20c2.2a Convert create_planned_workout endpoint to async. [complete]
20c2.2b Convert list_planned_workouts endpoint to async. [complete]
20c2.2c Convert weekly_planner endpoint to async. [complete]
20c2.2d Convert search_planned_workouts endpoint to async. [complete]
20c2.2e Convert update_planned_workout endpoint to async. [complete]
20c2.2f Convert delete_planned_workout endpoint to async. [complete]
20c2.2g Convert delete_planned_bulk endpoint to async. [complete]
20c2.2h Convert reorder_planned endpoint to async. [complete]
20c2.2i Convert duplicate_planned_workout endpoint to async. [pending]
20c2.2i.1 Asyncify `planner_service.duplicate_plan` method. [pending]
20c2.2i.2 Update REST API `duplicate_planned_workout` endpoint to async. [pending]
20c2.2i.3 Add tests for async duplicate plan endpoint. [pending]
20c2.2j Convert auto_plan endpoint to async. [pending]
20c2.2k Convert goal_plan endpoint to async. [pending]
20c2.2l Convert use_planned_workout endpoint to async. [pending]
20c2.2m Convert planned_workouts progress endpoint to async. [pending]
...
20d2.1 Add tests for AsyncSetRepository and async set endpoints. [complete]
20d2.2 Add tests for async planned workout operations. [complete]
